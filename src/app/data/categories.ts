...
export const departments: Department[] = [
  { id: "d-coffee", name: "Coffee & Drinks", nameAr: "قهوة ومشروبات", slug: "coffee-drinks", group: "foods", icon: "☕", description: "Arabic coffee, blends & natural juices", descriptionAr: "قهوة عربية ومشروبات طبيعية", image: "https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=600&auto=format&fit=crop", children: ["coffee-drinks"] },
